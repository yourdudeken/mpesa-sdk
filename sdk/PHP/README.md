...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/Yourdudeken/mpesa.svg?style=flat-square)](https://packagist.org/packages/Yourdudeken/mpesa)
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/yourdudeken/mpesa/ci.yml?logo=github&label=Tests)](https://github.com/Yourdudeken/mpesa/actions?query=workflow%3Arun-tests+branch%3Amain)
[![Total Downloads](https://img.shields.io/packagist/dt/Yourdudeken/mpesa.svg?style=flat-square)](https://packagist.org/packages/Yourdudeken/mpesa)
...
If you prefer a step by step tutorial, you can read the article I wrote on [How to integrate Mpesa into your Laravel Application](https://www.yourdudeken.com/blog/laravel-mpesa).
