...
use Yourdudeken\Mpesa\Utils\MpesaHelper;
...
class Mpesa
{
     ...
     * Business to Pochi
     *
     * This method is used to send money to a client's Pochi La Biashara account.
     *
     * @param int $phonenumber The phone number of the recipient in the format 254xxxxxxxxx
     * @param int $amount The amount to send to the recipient
     * @param string $remarks Any additional information. Must be present.
     * @param string|null $occasion Additional information.
     * @param string|null $result_url The Result Url where payload will be sent.
     * @param string|null $timeout_url The Timeout Url where payload will be sent. Must be present.
     * @param string $shortCodeType The type of shortcode to use. Can be C2B for incoming payments or B2C and B2B for outgoing payments.
     * @return \Illuminate\Http\Client\Response
     */
    public function b2pochi($phonenumber, $amount, $remarks, $occasion = null, $result_url = null, $timeout_url = null, $shortCodeType = 'B2C')
    {
        $url = $this->url . '/mpesa/b2pochi/v1/paymentrequest';
        ...
        $body = [
            ...
            'Remarks' => $remarks,
            'Occassion' => $occasion ?? '',
            'ResultURL' => $this->resolveCallbackUrl($result_url, 'b2pochi_result_url', 'b2pochi_result_url'),
            'QueueTimeOutURL' => $this->resolveCallbackUrl($timeout_url, 'b2pochi_timeout_url', 'b2pochi_timeout_url'),
        ];
